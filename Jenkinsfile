            ...
            steps {
                dir(WORKSPACE) {
                    sshagent(credentials:['5758cb36-4a4e-4586-9f77-f1d8b71221b7']) {
                        ...
                        sh 'ssh ec2-user@ec2-34-229-138-28.compute-1.amazonaws.com "forever stopall"'
                        ...
                        sh 'ssh ec2-user@ec2-34-229-138-28.compute-1.amazonaws.com "cd html && nohup forever server.js"'
                    }
                }
            }
        }
