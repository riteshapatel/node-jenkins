            ...
            steps {
                dir(WORKSPACE) {
                    sshagent(credentials:['5758cb36-4a4e-4586-9f77-f1d8b71221b7']) {
                        ...
                        sh 'ssh -f ec2-user@ec2-34-229-138-28.compute-1.amazonaws.com "export AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID} && export AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY} && cd html && nohup node server.js"'
                    }
                }
            }
        }
